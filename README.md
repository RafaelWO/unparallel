...
[![Build status](https://github.com/RafaelWO/unparallel/workflows/build/badge.svg?branch=master&event=push)](https://github.com/RafaelWO/unparallel/actions?query=workflow%3Abuild)
...
git branch -M main
git remote add origin https://github.com/RafaelWO/unparallel.git
...
@misc{unparallel,
  author = {RafaelWO},
  title = {Create async web requests in no time with `unparallel`},
  year = {2023},
  publisher = {GitHub},
  journal = {GitHub repository},
  howpublished = {\url{https://github.com/RafaelWO/unparallel}}
}
```
